...
public class TruckController {
    ...
    String filter = "truckid,truckname,cuisinetype,menus[menuitem[menuitemid,itemname,itemdescription,itemprice]],users[user[userid]],truckratings[truckratingid,score,user[userid]]";
